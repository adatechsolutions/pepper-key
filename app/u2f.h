...
void u2f_confirm_user_present(U2fData* instance, const uint8_t app_id[32]);

bool u2f_get_pending_app_id(const U2fData* instance, uint8_t app_id[32]);

void u2f_cancel_pending_request(U2fData* instance, const uint8_t app_id[32]);
